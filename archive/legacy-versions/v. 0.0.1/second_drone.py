...
def second_drone(drone, fire):
    ...
    for i in range(len(fp)-1):  # Adjust loop to avoid out of bounds when using i+1
        ...
        try:
            ...
            if y_move >= 500:
                ...
                drone.move_forward(y_move- 500)  
            else:
                drone.move_forward(y_move)
            # Pass y_move directly as distance
    ...
    time.sleep(1)  # Simulate drone flying for 5 seconds
