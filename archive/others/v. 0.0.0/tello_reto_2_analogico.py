...
def detect_line_3roi(frame):
    ...
    y1 = h//2 - roi_y - 55   ## Altura cuadros laterales -15
    cx2 = w//2 + roi_x +40   ## Ancho de cuadro central  --
        ...
        while True:
            ...
            if airborne and auto:
                ...
                # ---------- PHASE 3: FOLLOW BLUE LINE (TOP ROIs) ----------
                    ...
                    f, AL, AR, L, C, R, LL, LR = detect_line_3roi(f)
                    ...
                    if InputL >= 2 and InputL <= 7:
                        InputL = 7

                    if InputR >= 2 and InputR <= 7:
                        InputR = 7  

                    cv2.putText(f, "PHASE: FOLLOW_LINE", (10, 25),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
                    
                    # Si no esta en la pista
                    if not (L or C or R):
                        if last == "L":
                            lr = -13
                            yaw = -20
                        ...
                        # Spin corrections
                            ...
                            if C and L:
                                ...
                                fb = 15
                                yaw = +InputR - InputL
                                lr = + (InputR // 5) - (InputL // 5)
                                last = "R"
                                print(InputL, InputR)
                                print("CRL")
                            

                            # Corrections in the line
                            elif L and not C:
                                fb = 14
                                lr = - 15 
                                last = "L"
                        ...
                        # Strong Correction
                        elif LL and (LL and L) and not (C or R):
                            fb = 0
                            lr = -50
                            last = "L"
                            print("LL ONLY")
                        elif LR and (LR and R) and not (L or C or R):
                            fb = 0
                            lr = 50
                            last = "R"
                            print("RR ONLY")
